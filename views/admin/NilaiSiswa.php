                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#pilih"><i class="fa fa-print"></i> Cetak Raport Digital</button>
                                </div>
                                <!-- /.card-header -->
                                ...
                                <div class="modal fade" id="pilih" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Pilih Raport Siswa</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Tutup">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <form action="raport.php" method="post" target="_blank">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label class="control-label" for="Nama">Nama</label>
                                                    <input type="text" name="cetak_nama" class="form-control" id="cetak_nama">
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <input type="submit" class="btn btn-success" name="cetak_raport" value="Cetak Raport">
                                            </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="modal fade" id="validasi" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Validasi Administrasi Siswa</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Tutup">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                           <div class="modal-body">
                                                <h5>Apakah siswa ini sudah menyelesaikan administrasi?</h5>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
                                                <a href=raport.php><input type="submit" class="btn btn-success" name="ya" value="Ya"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
